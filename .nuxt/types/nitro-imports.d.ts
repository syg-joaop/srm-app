declare global {
  ...
  const createApiClient: typeof import('../../src/server/utils/api-client').createApiClient
  ...
  const useApiRequest: typeof import('../../src/server/utils/api-client').useApiRequest
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/Usuario/.gemini/antigravity/scratch/srm-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/Usuario/.gemini/antigravity/scratch/srm-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { useImage } from 'C:/Users/Usuario/.gemini/antigravity/scratch/srm-app/node_modules/@nuxt/image/dist/runtime/server/utils/image';
export { createApiClient, useApiRequest } from 'C:/Users/Usuario/.gemini/antigravity/scratch/srm-app/src/server/utils/api-client';