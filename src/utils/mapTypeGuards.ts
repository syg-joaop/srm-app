...
/**
 * Type guard para validar se um valor possui coordenadas geográficas válidas.
 *
 * @example
 * if (isValidCoordinate(someValue)) {
 *   // TypeScript sabe que someValue.latitude e someValue.longitude são number
 *   console.log(someValue.latitude, someValue.longitude);
 * }
 */
