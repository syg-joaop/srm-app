...
export const apiCompraSchema = z.object({
  ...
  liquido: z.string().optional(),
  preco_medio: z.string().optional(),
  desconto: z.string().optional(),
  media_diaria: z.string().optional(),
  preco_sem_icms: z.string().optional(),
  icms: z.string().optional(),
  totaldiasuteis: z.string().optional(),
  totalsabados: z.string().optional(),
});
...
export const dashboardApiResponseSchema = z.object({
  ...
  aniversariantesFornecedores: z.object({
    data: z.array(apiAniversarianteSchema),
  }),
