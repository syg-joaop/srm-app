<template>
  ...
  >
    ...
    <div
      ...
      :class="variant === 'current' ? 'bg-gradient-to-r from-primary via-primary/80 to-primary/40' : 'bg-gradient-to-r from-gray-400 via-gray-300 to-gray-200 dark:from-gray-600 dark:via-gray-500 dark:to-gray-400'"
    />
    ...
    <div class="px-4 sm:px-5 pt-4 pb-3 flex items-center justify-between">
      <div class="flex items-center gap-2.5">
        <div
          ...
          :class="variant === 'current' ? 'bg-primary/10 text-primary' : 'bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400'"
        >
      ...
      <div
        ...
        :class="trend > 0 ? 'bg-green-500/10 text-green-600 dark:text-green-400' : 'bg-red-500/10 text-red-600 dark:text-red-400'"
      >
