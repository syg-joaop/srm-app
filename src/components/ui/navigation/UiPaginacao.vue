<template>
  <div
    v-if="totalPages > 1"
    class="flex justify-center items-center gap-2 sm:gap-2"
  >
    <!-- First page button E -->
    <button
    ...
    >
      <ChevronsLeft
        class="w-5 h-5 sm:w-4 sm:h-4 text-[var(--color-text-muted)]"
      />
    </button>
    ...
    >
      <ChevronLeft
        class="w-6 h-6 sm:w-5 sm:h-5 md:w-4 md:h-4 text-[var(--color-text-muted)]"
      />
    </button>
